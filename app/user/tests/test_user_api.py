...
class PublicUserAPITests(TestCase):
	...
	def test_retreive_user_unauthorized(self):
		"""Test that authentivation is required for users"""
...
class PrivateUserApiTests(TestCase):
	...
	def setUp(self):
		...
		self.client.force_authenticate(user=self.user) # auth all reqs taht cln makes
	...
	def test_update_user_profile(self):
		"""Test updating user profile for autn user"""
		payload = {
